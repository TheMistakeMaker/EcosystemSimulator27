public enum PlantGene {
    ...
    MAX_CALORIES(260.0, 10.0, 500.0),
    MAX_WATER_STORAGE(125.0, 10.0, 500.0),

    STARTING_CALORIES(90.0, 0.0, 500.0),
    STARTING_WATER_RATIO(0.72, 0.0, 1.0),
    STARTING_HEIGHT(0.35, 0.0, 12.0),

    MAX_HEIGHT(5.0, 1.0, 12.0),
    GROWTH_RATE(0.028, 0.001, 1.0),
    GROWTH_CALORIE_COST(1.6, 0.0, 100.0),
    GROWTH_WATER_COST(0.9, 0.0, 100.0),
    LEAF_AREA(1.0, 0.30, 4.0),
    ROOT_DEPTH(2.0, 0.50, 6.0),

    PHOTOSYNTHESIS_RATE(1.05, 0.001, 10.0),
    PHOTOSYNTHESIS_EFFICIENCY(1.0, 0.25, 2.25),
    PHOTOSYNTHESIS_WATER_COST(0.18, 0.0, 10.0),

    WATER_ABSORPTION_RATE(1.35, 0.0, 10.0),
    DRY_SOIL_WATER_FACTOR(0.30, 0.0, 1.0),

    BASE_METABOLISM(0.10, 0.0, 10.0),
    ...
    CROWDING_TOLERANCE(3.2, 0.0, 20.0),
    CROWDING_DAMAGE(0.36, 0.0, 100.0),
    ...
    REPRODUCTION_COOLDOWN_TICKS(220.0, 0.0, 100000.0),
    SEED_CALORIES_REQUIRED(112.0, 0.0, 500.0),
    SEED_WATER_REQUIRED(48.0, 0.0, 500.0),
    SEED_HEALTH_REQUIRED(50.0, 0.0, 500.0),
    SEED_HEIGHT_REQUIRED(2.05, 0.0, 12.0),

    SEED_COUNT(1.0, 1.0, 5.0),
    SEED_SPREAD_DISTANCE(4.0, 1.0, 8.0),
    SEED_CALORIE_COST(56.0, 0.0, 500.0),
    SEED_WATER_COST(22.0, 0.0, 500.0),

    GROWTH_PRIORITY(0.58, 0.05, 1.5),
    REPRODUCTION_PRIORITY(0.27, 0.05, 1.5),
    SURVIVAL_PRIORITY(0.70, 0.05, 1.5),
    REPAIR_PRIORITY(0.20, 0.05, 1.5),

    MUTATION_RATE(0.06, 0.0, 0.25),
    MUTATION_STRENGTH(0.04, 0.0, 0.20),
